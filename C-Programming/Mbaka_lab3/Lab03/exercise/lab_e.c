/*---------------------------------------------------------------------------
  ...
  02/09/2021    R. Repka    Dump the command line
---------------------------------------------------------------------------*/
#include <stdio.h>
#include <stdlib.h>
#include <getopt.h>
...
int main (int argc, char **argv) {
  ...
  struct option long_options[] = {
    ...
    {"verb",    no_argument,       0, 'a'},  // Maps "verb" to 'a' (abbreviated version of verbose)
    {"append",  no_argument,       0, 'b'},  // Maps "append" to 'b'
    {"delete",  required_argument, 0, 'd'},  // Full text version of "del"
    {"file",    required_argument, 0, 'f'},  // Maps "file" to 'f'
    {"add",     no_argument,       0, 'a'},
  ...
  printf("Raw command line parameters: ");
