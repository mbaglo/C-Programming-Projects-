...
#include <math.h>
// #include <complex.h>    // but final timing and code must be run on our Linux cluster                                                                                        
...
/****************************************************************************
  ...
  analysis.txt file
 ***************************************************************************/
#define QN (23)                       /* place holder value, see above */
